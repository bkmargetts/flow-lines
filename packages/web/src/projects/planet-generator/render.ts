...
export function renderPlanet(state: PlanetState, env: RenderEnv): LayerOutput {
  ...
  const options: PlanetOptions = {
    ...
    lumpiness: state.lumpiness,
    tailLength: state.tailLength,
    tailSpread: state.tailSpread,
    ...
    orbitLabels: state.orbitLabels,
    asteroidBelt: state.asteroidBelt,
  ...
  const layerColors = pal
    ...
    : {
        ...
        tail: state.accentColor,
        callout: state.featureColor,
