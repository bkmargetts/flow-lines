...
export const PLANET_PALETTES: PlanetPalette[] = [
  {
    ...
    graticule: '#2a2a26', annotation: '#2a2a26', labelInk: '#2a2a26', callout: '#2a2a26',
  },
  {
    id: 'astronomical',
    ...
    graticule: '#6b5e7a', annotation: '#4a3320', labelInk: '#3a2f25', callout: '#3a2f25',
  },
  {
    id: 'saturn',
    label: 'Saturn brass',
    ...
    graticule: '#8a7a52', annotation: '#6e5326', labelInk: '#4a3a23', callout: '#4a3a23',
  },
  {
    id: 'lunar',
    ...
    graticule: '#5a5a5a', annotation: '#222222', labelInk: '#2c2c2c', callout: '#2c2c2c',
  },
  {
    id: 'mars',
    label: 'Mars sanguine',
    ...
    graticule: '#a86a55', annotation: '#5a2418', labelInk: '#6e2f1f', callout: '#6e2f1f',
  },
  {
    id: 'cyanotype',
    label: 'Cyanotype',
    ...
    graticule: '#3a6fa0', annotation: '#0e2a47', labelInk: '#13385e', callout: '#13385e',
  },
];
