...
export function renderVineGenerator(state: VineState, env: RenderEnv): LayerOutput {
  ...
  const options: VinesOptions = {
    ...
    leafArrangement: state.leafArrangement,
    leafletCount: state.leafletCount,
    phyllotaxis: state.phyllotaxis,
    whorlCount: state.whorlCount,
    ...
    inflorescence: state.inflorescence,
    floretCount: state.floretCount,
    thorns: state.thorns,
