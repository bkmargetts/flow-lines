...
export const LANDSCAPE_PRESETS: LandscapePreset[] = [
  ...
  // converted to mm/fraction units here).
  {
    ...
    state: {
      ...
      skyToneTop: 0.3, skyToneHorizon: 0.72, atmosphere: 0.45,
  ...
  },
  {
    ...
    state: {
      ...
      toneContrast: 0.6, crossHatch: 1, atmosphere: 0.8, focus: 0.3,
      skyToneTop: 0.2, skyToneHorizon: 0.46,
  ...
  },
  {
    ...
    state: {
      ...
      toneContrast: 0.65, skyToneTop: 0.22, skyToneHorizon: 0.46,
  ...
  },
  {
    ...
    state: {
      ...
      atmosphere: 0.3, focus: 0.4, skyToneTop: 0.22, skyToneHorizon: 0.6,
  ...
  },
  {
    ...
    state: {
      ...
      atmosphere: 0.55, focus: 0.45, skyToneTop: 0.4, skyToneHorizon: 0.62,
