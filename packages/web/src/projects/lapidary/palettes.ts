...
export const LAPIDARY_PALETTES: LapidaryPalette[] = [
  { id: 'specimen', label: 'Black & orange', inks: ['#1f1f1d', '#d4551a'] },
  { id: 'indigo-vermilion', label: 'Indigo & vermilion', inks: ['#1f3a5f', '#c3401f'] },
  { id: 'graphite-rust-teal', label: 'Graphite, rust & teal', inks: ['#2a2a26', '#8a3324', '#1f6f6a'] },
  { id: 'garden', label: 'Garden', inks: ['#3d5a28', '#c3401f', '#5a4a7f'] },
  { id: 'midnight-gold', label: 'Midnight & gold', inks: ['#20243f', '#b8860b'] },
  { id: 'mono', label: 'Single ink', inks: ['#1f1f1d'] },
];
