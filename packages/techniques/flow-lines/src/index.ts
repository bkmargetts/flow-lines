import { FlowField, type FlowFieldOptions, type Attractor, type FieldMode, createNoise } from '@flow-lines/core';

// Re-export types that consumers might need
export type { Attractor, FieldMode } from '@flow-lines/core';
